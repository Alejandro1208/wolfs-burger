...
-- Tiempo de generación: 30-07-2025 a las 18:18:19
...
(1, 'admin@burgers.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi');
...
CREATE TABLE `banners` (
  ...
  `alt_text` varchar(255) DEFAULT 'Banner'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `products` (
  ...
  `pedidosya_link` varchar(512) DEFAULT '#',
